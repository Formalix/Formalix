        ...
        if form.is_valid():
            ...
            if(to_parse[0] != ""):
                ...
                pre_prompt = ''.join(["mount everest 8000m above see level\n",
                                ...
                                "###\n"])
                print(pre_prompt)                                
                test = openai.Completion.create(engine="davinci", prompt= pre_prompt + to_complete + "\n###\n", max_tokens=400, temperature=0.3, stop="###", n=3)
                print(test)
                print('---------------')
                print(to_parse[1])
                print(to_parse[2])
            ...
            return render(request=request, template_name='Portal/index.html', context={"document_form": formcopy})    
        else: 
